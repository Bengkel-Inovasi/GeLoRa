...
echo ""
echo "  BACKEND:"
echo "  cd ~/GeLoRa/backend"
echo "  go run ./cmd/core/main.go"
echo ""
echo "  CLOUDFLARE TUNNEL (for remote access):"
echo "  cloudflared tunnel --url http://localhost:8080"
echo "  (copy the https://xxx.trycloudflare.com URL to Vercel env)"
echo ""
echo "  FRONTEND (local only):"
echo "  cd ~/GeLoRa && npm run dev"
echo ""
echo "  Remote dashboard: your Vercel URL"
